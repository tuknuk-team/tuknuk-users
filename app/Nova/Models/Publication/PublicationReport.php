...
class PublicationReport extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\Publication\PublicationReport::class;
    ...
    {
        return [
            (new CountModel(\App\Models\Publication\PublicationReport::class,'Total de denuncias'))->width('1/2')->icon('exclamation-circle'),
        ];
    }
